...
sudo cp ChipDip-DAC-driver-Volumio2-RPI-2-3/snd-soc-chipdip-dac-4.19.188-v7.ko /lib/modules/`uname -r`/kernel/sound/soc/bcm/snd-soc-chipdip-dac.ko
sudo cp ChipDip-DAC-driver-Volumio2-RPI-2-3/chipdip-dac.dtbo /boot/overlays/chipdip-dac.dtbo
sudo depmod
